...
class FPexp(object):
    ...
    def __init__(self, FPs, FPList, distribution = 'uni', tr_per_block = 500):
        """
    ...
    def make_block(self, FPList, tr_per_block = 500):
        """
...
class FPgonogo(FPexp):
    ...
    def __init__(self, gngList, relax = 1, *args, **kwargs):
        """
