...
for ik in range(len(kList)):
    for ir in range(len(rList)):
        for ic in range(len(cList)):
            ...
            #simResults.append((hazardSlope,seqSlopeDiff))
...
#=================== plot those indices in a scatterplot ======================#
plt.scatter(*zip(*simResults2))
plt.show()

# By parameters value

resultsk1, resultsk2, resultsk3, resultsk4, resultsk5, resultsk6, resultsk7, resultsk8, resultsk9, resultsk10 = (([None]*len(rList)*len(cList)) for ik in range(len(kList)))
